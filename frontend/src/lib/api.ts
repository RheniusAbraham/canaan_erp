...
function fromClosure(f: TripClosureData) {
  return {
    bill_to: f.billTo,
    trip_completed_date: f.tripCompletedDate,
    trip_closing_date: f.tripClosingDate,
    hire_amount: parseFloat(f.hireAmount) || 0,
    transport_amount: parseFloat(f.transportAmount) || 0,
    billing_amount: parseFloat(f.billingAmount) || 0,
